...
export const site = {
  ...
  about: {
    paragraphs: [
      ...
      },
      {
        ...
        techItems: ['SQL', 'Tableau', 'Python', 'Microsoft Excel', 'Git & GitHub', 'Data Visualization', 'Epidemiology', 'Biostatistics'],
      },
    ],
  },
  experiences: [
  ...
  contact: {
    email: 'casejanej10@gmail.com',
    github: 'https://casegetscreative.github.io',
    linkedin: 'https://www.linkedin.com/in/casey-jjohnson/',
  },
} as const;
